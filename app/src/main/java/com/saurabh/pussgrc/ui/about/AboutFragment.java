...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list.add(new BranchModel(R.drawable.ic_ece,"Electronics & Communications","Department of Electronics & Communication is one of the most sought after department of BMSCE and boasts of excellent infrastructure. The students are motivated to take up challenging projects and enhance their practical skills in electronics. The department is well equipped in all aspects and has the following labs."));
        ...
        Picasso.get()
                .load("https://images.static-collegedunia.com/public/college_data/images/campusimage/1476274138Capture.JPG20.JPG")
                .into(imageView);
